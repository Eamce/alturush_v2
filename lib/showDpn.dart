  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        leading: IconButton(
          icon: Icon(
            CupertinoIcons.left_chevron, color: Colors.black54,size: 20,
          ),
              ...
              child: ListView(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child:Text("Effective: March 13, 2020",
                      style: TextStyle(
                  ...
                  Padding(
                    ...
                    child: Text("SCOPE OF THIS NOTICE",
                  ...
                  Padding(
                    padding:EdgeInsets.fromLTRB(10.0, 10.0, 0.0, 5.0),
                    child:Text("ALTURUSH is a registered brand name and food delivery support of Alturas Group of Companies.",
                      style: TextStyle(fontWeight: FontWeight.bold,fontSize: 17,
                      ),
                    ),
                  ),
                  ...
                  Padding(
                    padding:EdgeInsets.fromLTRB(10.0, 10.0, 0.0, 5.0),
                    child:Text("1.SOURCES OF PERSONAL DATA",
                      style: TextStyle(fontWeight: FontWeight.bold,fontSize: 17,
                      ),
                    ),
                  ),
                  ...
                  Padding(
                    padding:EdgeInsets.fromLTRB(10.0, 10.0, 0.0, 5.0),
                    child:Text("This Notice applies to Personal Data that We collect from or about you, through the methods described below and their corresponding sources.",
                      style: TextStyle(fontSize: 17,
                      ),
                    ),
                  ),
                  ...
                  Padding(
                    padding:EdgeInsets.fromLTRB(10.0, 10.0, 0.0, 5.0),
                    child:Text("“Personal Data” is any information which can be used to identify you or form which you are identifiable. This includes but is not limited to you name, nationality, telephone number, bank and credit card details, personal interests, email address, you image, government-issued identification numbers, biometric data, race, date of birth, marital status, religion, health information, vehicle and insurance information, employment information and financial information.",
                      style: TextStyle(fontWeight: FontWeight.bold,fontSize: 17,
                      ),
                    ),
                  ),
                  ...
                  Padding(
                    padding:EdgeInsets.fromLTRB(10.0, 10.0, 0.0, 5.0),
                    child:Text("ALTURUSH websites. Consumer-directed websites operated by or for ALTURUSH, including sites that We operate under our own domains/URLs and mini-sites that We run on third party social networks such as Facebook (“Websites”).",
                      style: TextStyle(fontSize: 17,
                      ),
                    ),
                  ),
                  ...
                  Padding(
                    padding:EdgeInsets.fromLTRB(10.0, 10.0, 0.0, 5.0),
                    child:Text("ALTURUSH mobile sites/apps. Consumer-directed mobile sites or applications operated by or for ALTURUSH, such as smartphone apps.",
                      style: TextStyle(fontSize: 17,
                      ),
                    ),
                  ),
                  ...
                  Padding(
                    padding:EdgeInsets.fromLTRB(10.0, 10.0, 0.0, 5.0),
                    child:Text("E-mail, text and other electronic messages. Interactions with electronic communications between you and ALTURUSH.",
                      style: TextStyle(fontSize: 17,
                      ),
                    ),
                  ),
                  ...
                  Padding(
                    padding:EdgeInsets.fromLTRB(10.0, 10.0, 0.0, 5.0),
                    child:Text("Offline registration forms. Printed or digital registration and similar forms that We collect via, for example, postal mail, in-store demos, contests, sampling activities, and other promotions, or events.",
                      style: TextStyle(fontSize: 17,
                      ),
                    ),
                  ),
                  ...
                  Padding(
                    padding:EdgeInsets.fromLTRB(10.0, 10.0, 0.0, 5.0),
                    child:Text("Advertising interactions. Interactions with our advertisements (e.g., if you interact with on one of our ads on a third party website, we may receive information about that interaction).",
                      style: TextStyle(fontSize: 17,
                      ),
                    ),
                  ),
                  ...
                  Padding(
                    padding:EdgeInsets.fromLTRB(10.0, 10.0, 0.0, 5.0),
                    child:Text("Data from other sources. Third party social networks (e.g. such as Facebook, Google), market research (if feedback not provided on an anonymous basis), third party data aggregators, ALTURUSH promotional partners, public sources and data received when we acquire other companies.",
                      style: TextStyle(fontSize: 17,
                      ),
                    ),
                  ),
                  ...
                  Padding(
                    padding:EdgeInsets.fromLTRB(10.0, 10.0, 0.0, 5.0),
                    child:Text("2.PERSONAL DATA THAT WE COLLECT ABOUT YOU AND HOW WE COLLECT IT",
                      style: TextStyle(fontWeight: FontWeight.bold,fontSize: 17,
                      ),
                    ),
                  ),
                  ...
                  Padding(
                    padding:EdgeInsets.fromLTRB(10.0, 10.0, 0.0, 5.0),
                    child:Text("Depending on how you interact with ALTURUSH (online, offline, over the phone, etc.), We collect various types of information from you, as described below.",
                      style: TextStyle(fontSize: 17,
                      ),
                    ),
                  ),
                  ...
                  Padding(
                    padding:EdgeInsets.fromLTRB(10.0, 10.0, 0.0, 5.0),
                    child:Text("Summary of Sources of Data:",
                      style: TextStyle(fontWeight: FontWeight.bold,fontSize: 17,
                      ),
                    ),
                  ),
                  ...
                  Padding(
                    padding:EdgeInsets.fromLTRB(10.0, 10.0, 0.0, 5.0),
                    child:Text("a. Personal Contact Information",
                      style: TextStyle(fontSize: 17,
                      ),
                    ),
                  ),
                  ...
                  Padding(
                    padding:EdgeInsets.fromLTRB(10.0, 10.0, 0.0, 5.0),
                    child:Text("b. Account Login information",
                      style: TextStyle(fontSize: 17,
                      ),
                    ),
                  ),
                  ...
                  Padding(
                    padding:EdgeInsets.fromLTRB(10.0, 10.0, 0.0, 5.0),
                    child:Text("c. Demographic information & interests",
                      style: TextStyle(fontSize: 17,
                      ),
                    ),
                  ),
                  ...
                  Padding(
                    padding:EdgeInsets.fromLTRB(10.0, 10.0, 0.0, 5.0),
                    child:Text("d. Information from computer / mobile device",
                      style: TextStyle(fontSize: 17,
                      ),
                    ),
                  ),
                  ...
                  Padding(
                    padding:EdgeInsets.fromLTRB(10.0, 10.0, 0.0, 5.0),
                    child:Text("e. Websites / communication usage information",
                      style: TextStyle(fontSize: 17,
                      ),
                    ),
                  ),
                  ...
                  Padding(
                    padding:EdgeInsets.fromLTRB(10.0, 10.0, 0.0, 5.0),
                    child:Text("f. Market research & consumer feedback",
                      style: TextStyle(fontSize: 17,
                      ),
                    ),
                  ),
                  ...
                  Padding(
                    padding:EdgeInsets.fromLTRB(10.0, 10.0, 0.0, 5.0),
                    child:Text("g. Consumer-generated content",
                      style: TextStyle(fontSize: 17,
                      ),
                    ),
                  ),
                  ...
                  Padding(
                    padding:EdgeInsets.fromLTRB(10.0, 10.0, 0.0, 5.0),
                    child:Text("h. Third party social network information",
                      style: TextStyle(fontSize: 17,
                      ),
                    ),
                  ),
                  ...
                  Padding(
                    padding:EdgeInsets.fromLTRB(10.0, 10.0, 0.0, 5.0),
                    child:Text("i. Payment and Financial information",
                      style: TextStyle(fontSize: 17,
                      ),
                    ),
                  ),
                  ...
                  Padding(
                    padding:EdgeInsets.fromLTRB(10.0, 10.0, 0.0, 5.0),
                    child:Text("j. Sensitive Personal Data (Prior Express Consent)",
                      style: TextStyle(fontSize: 17,
                      ),
                    ),
                  ),
                  ...
                  Padding(
                    padding:EdgeInsets.fromLTRB(10.0, 10.0, 0.0, 5.0),
                    child:Text("Personal contact information",
                      style: TextStyle(fontWeight: FontWeight.bold,fontSize: 17,
                      ),
                    ),
                  ),
                  ...
                  Padding(
                    ...
                    child:Text("This includes any information you provide to Us that would allow Us to contact you, such as your name, postal address, e-mail address, social network details, or phone number.",
                      style: TextStyle(fontSize: 17,
                      ),
                    ),
                  ),
                  ...
                  Padding(
                    padding:EdgeInsets.fromLTRB(10.0, 10.0, 0.0, 5.0),
                    child:Text("Account login information",
                      style: TextStyle(fontWeight: FontWeight.bold,fontSize: 17,
                      ),
                    ),
                  ),
                  ...
                  Padding(
                    padding:EdgeInsets.fromLTRB(10.0, 0.0, 0.0, 5.0),
                    child:Text("Any information that is required to give you access to your specific account profile. Examples include your login ID/email address, screen name, password in unrecoverable form, and/or security question and answer.",
                      style: TextStyle(fontSize: 17,
                      ),
                    ),
                  ),
                  ...
                  Padding(
                    padding:EdgeInsets.fromLTRB(10.0, 10.0, 0.0, 5.0),
                    child:Text("Demographic information & interests",
                      style: TextStyle(fontWeight: FontWeight.bold,fontSize: 17,
                      ),
                    ),
                  ),
                  ...
                  Padding(
                    padding:EdgeInsets.fromLTRB(10.0, 0.0, 0.0, 5.0),
                    child:Text("Any information that describes your demographic or behavioral characteristics. Examples include your year of birth, age range, gender, geographic location (e.g. postcode/zip code), favorite products, hobbies and interests, and household or lifestyle information.",
                      style: TextStyle(fontSize: 17,
                      ),
                    ),
                  ),
                  ...
                  Padding(
                    padding:EdgeInsets.fromLTRB(10.0, 10.0, 0.0, 5.0),
                    child:Text("Information from computer/mobile device",
                      style: TextStyle(fontWeight: FontWeight.bold,fontSize: 17,
                      ),
                    ),
                  ),
                  ...
                  Padding(
                    padding:EdgeInsets.fromLTRB(10.0, 10.0, 0.0, 5.0),
                    child:Text("Websites/communication usage information",
                      style: TextStyle(fontWeight: FontWeight.bold,fontSize: 17,
                      ),
                    ),
                  ),
                  ...
                  Padding(
                    padding:EdgeInsets.fromLTRB(10.0, 10.0, 0.0, 5.0),
                    child:Text("Market research & consumer feedback",
                      style: TextStyle(fontWeight: FontWeight.bold,fontSize: 17,
                      ),
                    ),
                  ),
                  ...
                  Padding(
                    padding:EdgeInsets.fromLTRB(10.0, 0.0, 0.0, 5.0),
                    child:Text("Any information that you voluntarily share with Us about your experience of using our products and services.",
                      style: TextStyle(fontSize: 17,
                      ),
                    ),
                  ),
                  ...
                  Padding(
                    padding:EdgeInsets.fromLTRB(10.0, 10.0, 0.0, 5.0),
                    child:Text("Consumer-generated content",
                      style: TextStyle(fontWeight: FontWeight.bold,fontSize: 17,
                      ),
                    ),
                  ),
                  ...
                  Padding(
                    padding:EdgeInsets.fromLTRB(10.0, 10.0, 0.0, 5.0),
                    child:Text("Third party social network information",
                      style: TextStyle(fontWeight: FontWeight.bold,fontSize: 17,
                      ),
                    ),
                  ),
                  ...
                  Padding(
                    padding:EdgeInsets.fromLTRB(10.0, 0.0, 0.0, 5.0),
                    child:Text("Any information that you share publicly on a third party social network or information that is part of your profile on a third party social network (such as Facebook) and that you allow the third party social network to share with Us. Examples include your basic account information (e.g. name, email address, gender, birthday, current city, profile picture, user ID, list of friends, etc.) and any other additional information or activities that you permit the third party social network to share. We receive your third party social network profile information (or parts of it) every time you download or interact with ALTURUSH web application on a third party social network such as Facebook, every time you use a social networking feature that is integrated within ALTURUSH site (such as Facebook Connect) or every time you interact with Us through a third party social network. To learn more about how your information from a third party social network is obtained by ALTURUSH, or to opt-out of sharing such social network information, please visit the website of the relevant third party social network.",
                      style: TextStyle(fontSize: 17,
                      ),
                    ),
                  ),
                  ...
                  Padding(
                    padding:EdgeInsets.fromLTRB(10.0, 10.0, 0.0, 5.0),
                    child:Text("Payment and Financial information",
                      style: TextStyle(fontWeight: FontWeight.bold, fontSize: 17,
                      ),
                    ),
                  ),
                  ...
                  Padding(
                    padding:EdgeInsets.fromLTRB(10.0, 10.0, 0.0, 5.0),
                    child:Text("Sensitive Personal Data",
                      style: TextStyle(fontWeight: FontWeight.bold, fontSize: 17,
                      ),
                    ),
                  ),
                  ...
                  Padding(
                    ...
                    child:Text("Thus, where it becomes necessary to collect and process your sensitive personal information as defined above, We rely on your prior express consent and/or in strict compliance with applicable laws.",
                      style: TextStyle(fontSize: 17,
                      ),
                    ),
                  ),
                  ...
                  Padding(
                    padding:EdgeInsets.fromLTRB(10.0, 10.0, 0.0, 5.0),
                    child:Text("3.COOKIES/SIMILAR TECHNOLOGIES, LOG FILES AND WEB BEACONS",
                      style: TextStyle(fontWeight: FontWeight.bold,fontSize: 17,
                      ),
                    ),
                  ),
                  ...
                  Padding(
                    padding:EdgeInsets.fromLTRB(10.0, 10.0, 0.0, 5.0),
                    child:Text("Cookies/Similar Technologies",
                      style: TextStyle(fontWeight: FontWeight.bold,fontSize: 17,
                      ),
                    ),
                  ),
                  ...
                  Padding(
                    padding:EdgeInsets.fromLTRB(10.0, 0.0, 0.0, 5.0),
                    child:Text("Please see our Cookie Notice to learn how you can manage your cookie settings and for detailed information on the cookies We use and the purposes for which We use them.",
                      style: TextStyle(fontSize: 17,
                      ),
                    ),
                  ),
                  ...
                  Padding(
                    padding:EdgeInsets.fromLTRB(10.0, 0.0, 0.0, 5.0),
                    child:Text("We collect information in the form of log files that record website activity and gather statistics about your browsing habits. These entries are generated automatically, and help Us to troubleshoot errors, improve performance and maintain the security of our Websites.",
                      style: TextStyle(fontSize: 17,
                      ),
                    ),
                  ),
                  ...
                  Padding(
                    padding:EdgeInsets.fromLTRB(10.0, 10.0, 0.0, 5.0),
                    child:Text("4. USES MADE OF YOUR PERSONAL DATA",
                      style: TextStyle(fontWeight: FontWeight.bold,fontSize: 17,
                      ),
                    ),
                  ),
                  ...
                  Padding(
                    padding:EdgeInsets.fromLTRB(10.0, 0.0, 0.0, 5.0),
                    child:Text("The following paragraphs describe the various purposes for which We collect and use your Personal Data, and the different types of Personal Data that are collected for each purpose. Please note that not all of the uses below will be relevant to every individual.",
                      style: TextStyle(fontSize: 17,
                      ),
                    ),
                  ),
                  ...
                  Padding(
                    padding:EdgeInsets.fromLTRB(10.0, 10.0, 0.0, 5.0),
                    child:Text("What We use your Personal Data for",
                      style: TextStyle(fontWeight: FontWeight.bold,fontSize: 17,
                      ),
                    ),
                  ),
                  ...
                  Padding(
                    padding:EdgeInsets.fromLTRB(10.0, 0.0, 0.0, 5.0),
                    child:Text("*Fulfilling contractual obligations",
                      style: TextStyle(fontSize: 17,
                      ),
                    ),
                  ),
                  ...
                  Padding(
                    padding:EdgeInsets.fromLTRB(10.0, 0.0, 0.0, 5.0),
                    child:Text("*Our legitimate interests",
                      style: TextStyle(fontSize: 17,
                      ),
                    ),
                  ),
                  ...
                  Padding(
                    padding:EdgeInsets.fromLTRB(10.0, 0.0, 0.0, 5.0),
                    child:Text("*Monitoring and improving products and services and developing new ones",
                      style: TextStyle(fontSize: 17,
                      ),
                    ),
                  ),
                  ...
                  Padding(
                    padding:EdgeInsets.fromLTRB(10.0, 0.0, 0.0, 5.0),
                    child:Text("*Being more efficient",
                      style: TextStyle(fontSize: 17,
                      ),
                    ),
                  ),
                  ...
                  Padding(
                    padding:EdgeInsets.fromLTRB(10.0, 0.0, 0.0, 5.0),
                    child:Text("*Respond to questions, comments, and feedbacks",
                      style: TextStyle(fontSize: 17,
                      ),
                    ),
                  ),
                  ...
                  Padding(
                    padding:EdgeInsets.fromLTRB(10.0, 10.0, 0.0, 5.0),
                    child:Text("Contests, marketing and other promotions",
                      style: TextStyle(fontWeight: FontWeight.bold, fontSize: 17,
                      ),
                    ),
                  ),
                  ...
                  Padding(
                    padding:EdgeInsets.fromLTRB(10.0, 0.0, 0.0, 5.0),
                    child:Text("*With your consent (where required)",
                      style: TextStyle(fontSize: 17,
                      ),
                    ),
                  ),
                  ...
                  Padding(
                    padding:EdgeInsets.fromLTRB(10.0, 0.0, 0.0, 5.0),
                    child:Text("*Working out which of our products and services may interest you and telling you about them",
                      style: TextStyle(fontSize: 17,
                      ),
                    ),
                  ),
                  ...
                  Padding(
                    padding:EdgeInsets.fromLTRB(10.0, 0.0, 0.0, 5.0),
                    child:Text("*Defining types of consumers for new products or services",
                      style: TextStyle(fontSize: 17,
                      ),
                    ),
                  ),
                  ...
                  Padding(
                    padding:EdgeInsets.fromLTRB(10.0, 10.0, 0.0, 5.0),
                    child:Text("Third party social networks",
                      style: TextStyle(fontWeight: FontWeight.bold,fontSize: 17,
                      ),
                    ),
                  ),
                  ...
                  Padding(
                    padding:EdgeInsets.fromLTRB(10.0, 0.0, 0.0, 5.0),
                    child:Text("*With your consent (where required) Our legitimate interests",
                      style: TextStyle(fontSize: 17,
                      ),
                    ),
                  ),
                  ...
                  Padding(
                    padding:EdgeInsets.fromLTRB(10.0, 10.0, 0.0, 5.0),
                    child:Text("Personalization (offline and online)",
                      style: TextStyle(fontWeight: FontWeight.bold,fontSize: 17,
                      ),
                    ),
                  ),
                  ...
                  Padding(
                    padding:EdgeInsets.fromLTRB(10.0, 0.0, 0.0, 5.0),
                    child:Text("We use your Personal Data to process and ship your orders, inform you about the status of your orders, correct addresses and conduct identity verification and other fraud detection activities. This involves the use of certain Personal Data and payment information.",
                      style: TextStyle(fontSize: 17,
                      ),
                    ),
                  ),
                  ...
                  Padding(
                    padding:EdgeInsets.fromLTRB(10.0, 0.0, 0.0, 5.0),
                    child:Text("*Improving and developing new products and services",
                      style: TextStyle(fontSize: 17,
                      ),
                    ),
                  ),
                  ...
                  Padding(
                    padding:EdgeInsets.fromLTRB(10.0, 0.0, 0.0, 5.0),
                    child:Text("*Protect our systems, networks and staff",
                      style: TextStyle(fontSize: 17,
                      ),
                    ),
                  ),
                  ...
                  Padding(
                    padding:EdgeInsets.fromLTRB(10.0, 0.0, 0.0, 5.0),
                    child:Text("*Compliance with legal obligations",
                      style: TextStyle(fontSize: 17,
                      ),
                    ),
                  ),
                  ...
                  Padding(
                    padding:EdgeInsets.fromLTRB(10.0, 0.0, 0.0, 5.0),
                    child:Text("*Testing, analyzing and product development",
                      style: TextStyle(fontSize: 17,
                      ),
                    ),
                  ),
                  ...
                  Padding(
                    padding:EdgeInsets.fromLTRB(10.0, 0.0, 0.0, 5.0),
                    child:Text("*Understand and analyze your needs and preferences",
                      style: TextStyle(fontSize: 17,
                      ),
                    ),
                  ),
                  ...
                  Padding(
                    padding:EdgeInsets.fromLTRB(10.0, 0.0, 0.0, 5.0),
                    child:Text("*Improve and enhance the safety and security of our services",
                      style: TextStyle(fontSize: 17,
                      ),
                    ),
                  ),
                  ...
                  Padding(
                    padding:EdgeInsets.fromLTRB(10.0, 0.0, 0.0, 5.0),
                    child:Text("*Develop new features, product and services",
                      style: TextStyle(fontSize: 17,
                      ),
                    ),
                  ),
                  ...
                  Padding(
                    ...
                    child:Text("Our legitimate purpose: Investigate and resolve claims or disputes or as allowed or required by applicable law.",
                      style: TextStyle(fontSize: 17,
                      ),
                    ),
                  ),
                  ...
                  Padding(
                    padding:EdgeInsets.fromLTRB(10.0, 50.0, 0.0, 5.0),
                    child:Text("5. DISCLOSURE OF YOUR PERSONAL DATA",
                      style: TextStyle(fontWeight: FontWeight.bold,fontSize: 17,
                      ),
                    ),
                  ),
                  ...
                  Padding(
                    padding:EdgeInsets.fromLTRB(10.0, 20.0, 0.0, 5.0),
                    child:Text("We share your Personal Data with the following types of third party organizations:",
                      style: TextStyle(fontSize: 17,
                      ),
                    ),
                  ),
                  ...
                  Padding(
                    padding:EdgeInsets.fromLTRB(10.0, 10.0, 0.0, 5.0),
                    child:Text("6. RETENTION OF YOUR PERSONAL DATA",
                      style: TextStyle(fontWeight: FontWeight.bold,fontSize: 17,
                      ),
                    ),
                  ),
                  ...
                  Padding(
                    padding:EdgeInsets.fromLTRB(10.0, 10.0, 0.0, 5.0),
                    child:Text("7. DISCLOSURE, STORAGE AND/OR TRANSFER OF YOUR PERSONAL DATA",
                      style: TextStyle(fontWeight: FontWeight.bold,fontSize: 17,
                      ),
                    ),
                  ),
                  ...
                  Padding(
                    padding:EdgeInsets.fromLTRB(10.0, 0.0, 0.0, 5.0),
                    child:Text("We take reasonable, legal, organizational, and technical measures (described below) to keep your Personal Data confidential and secure.",
                      style: TextStyle(fontSize: 17,
                      ),
                    ),
                  ),
                  ...
                  Padding(
                    padding:EdgeInsets.fromLTRB(10.0, 10.0, 0.0, 5.0),
                    child:Text("People who can access your Personal Data",
                      style: TextStyle(fontWeight: FontWeight.bold,fontSize: 17,
                      ),
                    ),
                  ),
                  ...
                  Padding(
                    padding:EdgeInsets.fromLTRB(10.0, 0.0, 0.0, 5.0),
                    child:Text("Your Personal Data will be processed by our authorized staff or agents, on a need to know basis, depending on the specific purposes for which your Personal Data have been collected (e.g. our staff in charge of consumer care matters will have access to your consumer record).",
                      style: TextStyle(fontSize: 17,
                      ),
                    ),
                  ),
                  ...
                  Padding(
                    padding:EdgeInsets.fromLTRB(10.0, 10.0, 0.0, 5.0),
                    child:Text("Measures taken in operating environments",
                      style: TextStyle(fontWeight: FontWeight.bold, fontSize: 17,
                      ),
                    ),
                  ),
                  ...
                  Padding(
                    padding:EdgeInsets.fromLTRB(10.0, 10.0, 0.0, 5.0),
                    child:Text("Measures We expect you to take",
                      style: TextStyle(fontWeight: FontWeight.bold, fontSize: 17,
                      ),
                    ),
                  ),
                  ...
                  Padding(
                    padding:EdgeInsets.fromLTRB(10.0, 10.0, 0.0, 5.0),
                    child:Text("Access to Personal Data",
                      style: TextStyle(fontWeight: FontWeight.bold, fontSize: 17,
                      ),
                    ),
                  ),
                  ...
                  Padding(
                    padding:EdgeInsets.fromLTRB(10.0, 0.0, 0.0, 5.0),
                    child:Text("You have the right to access, review and request a physical or electronic copy of information held about you. You also have the right to request information on the source of your Personal Data.",
                      style: TextStyle(fontSize: 17,
                      ),
                    ),
                  ),
                  ...
                  Padding(
                    padding:EdgeInsets.fromLTRB(10.0, 10.0, 0.0, 5.0),
                    child:Text("Additional rights (e.g. modification, deletion of Personal Data)",
                      style: TextStyle(fontWeight: FontWeight.bold,fontSize: 17,
                      ),
                    ),
                  ),
                  ...
                  Padding(
                    padding:EdgeInsets.fromLTRB(10.0, 10.0, 0.0, 5.0),
                    child:Text("9. CHANGES TO THIS NOTICE",
                      style: TextStyle(fontWeight: FontWeight.bold,fontSize: 17,
                      ),
                    ),
                  ),
                  ...
                  Padding(
                    padding:EdgeInsets.fromLTRB(10.0, 0.0, 0.0, 5.0),
                    child:Text("If We change the way We handle your Personal Data, We will update this Notice. We reserve the right to make changes to our practices and this Notice at any time, please check back frequently to see any updates or changes to our Notice.",
                      style: TextStyle(fontSize: 17,
                      ),
                    ),
                  ),
                  ...
                  Padding(
                    padding:EdgeInsets.fromLTRB(10.0, 10.0, 0.0, 5.0),
                    child:Text("10.DATA CONTROLLERS & CONTACT",
                      style: TextStyle(fontWeight: FontWeight.bold, fontSize: 17,
                      ),
                    ),
                  ),
                  ...
                  Padding(
                    padding:EdgeInsets.fromLTRB(10.0, 0.0, 0.0, 5.0),
                    child:Text("To ask questions or make comments on this Notice and our privacy practices or to make a complaint about our compliance with applicable privacy laws, you may reach us through our Contact Us page.",
                      style: TextStyle(fontSize: 17,
                      ),
                    ),
                  ),
                  ...
                  Padding(
                    padding:EdgeInsets.fromLTRB(10.0, 20.0, 0.0, 5.0),
                    child:Text("You can also contact our Data Protection contact via email at: dpo@alturasbohol.com.",
                      style: TextStyle(fontSize: 17,
                      ),
                    ),
                  ),
                  ...
                  Padding(
                    padding:EdgeInsets.fromLTRB(10.0, 20.0, 0.0, 5.0),
                    child:Text("We will acknowledge and investigate any complaint about the way we manage Personal Data (including a complaint that we have breached your rights under applicable privacy laws).",
                      style: TextStyle(fontSize: 17,
                      ),
                    ),
                  ),
                  ...
                  Padding(
                    padding:EdgeInsets.fromLTRB(10.0, 20.0, 0.0, 5.0),
                    child:Text("Data Privacy Officer:",
                      style: TextStyle(fontSize: 17,
                      ),
                    ),
                  ),
                  ...
                  Padding(
                    padding:EdgeInsets.fromLTRB(10.0, 0.0, 0.0, 5.0),
                    child:Text("dpo@alturasbohol.com",
                      style: TextStyle(fontSize: 17,
                      ),
                    ),
                  ),
                  ...
                  Padding(
                    padding:EdgeInsets.fromLTRB(10.0, 0.0, 0.0, 5.0),
                    child:Text("3F AGC Corporate Center",
                      style: TextStyle(fontSize: 17,
                      ),
                    ),
                  ),
                  ...
                  Padding(
                    padding:EdgeInsets.fromLTRB(10.0, 0.0, 0.0, 5.0),
                    child:Text("Dao, Dampas, Tagbilaran City, Bohol",
                      style: TextStyle(fontSize: 17,
                      ),
                    ),
                  ),
                  ...
                  Padding(
                    padding:EdgeInsets.fromLTRB(10.0, 0.0, 0.0, 5.0),
                    child:Text("(038) 501-3000, local 1120, (038) 501-3015",
                      style: TextStyle(fontSize: 17,
                      ),
                    ),
                  ),
