                                                            ...
                                                            Padding(
                                                              ...
                                                              child: SizedBox(
                                                                ...
                                                                child: TextButton(
                                                                  ...
                                                                  Text('DELETE',
                                                                    style: TextStyle(
                                                                      fontStyle: FontStyle.normal, fontSize: 11, color: Colors.redAccent,
                                                                    ),
                                                                  ),
                                                                ),
                                                              ),
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            ...
                            Text('$stores',
                              style: TextStyle(
                                fontStyle: FontStyle.normal,fontSize: 13.0, fontWeight: FontWeight.normal, color: Colors.black87,
                              ),
                            ),
                          ],
                        ),
                          ...
                          child: Row(
                            ...
                            children: <Widget>[
                              Text('TOTAL AMOUNT TO PAY',
                                style: GoogleFonts.openSans(
                                  fontStyle: FontStyle.normal,fontSize: 13.0, fontWeight: FontWeight.bold, color: Colors.deepOrangeAccent,
                                ),
                              ),
                              Text('₱ ${oCcy.format(grandTotal)}',
                                style: TextStyle(
                                  fontStyle: FontStyle.normal,fontSize: 13.0, fontWeight: FontWeight.bold, color: Colors.black87,
                                ),
                              ),
                            ],
                          ),
