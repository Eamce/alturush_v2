...
class _ProfileSettings extends State<ProfileSettings> with SingleTickerProviderStateMixin{
  final db = RapidA();
        ...
        bottom: TabBar(
          ...
          tabs: [
            Tab(
              child: Text("Profile",
                style: GoogleFonts.openSans(
                  fontStyle: FontStyle.normal, fontWeight: FontWeight.bold, fontSize: 15.0, color: Colors.white,
                ),
              ),
            ),
            Tab(
                        ...
                        child: Flexible(
                          child: SleekButton(
                            ...
                            child: Center(
                              child: Text("SUBMIT",
                                style:TextStyle(
                                  fontStyle: FontStyle.normal,fontSize: 18.0, fontWeight: FontWeight.bold,
                                ),
                              ),
                            ),
                          ),
