          ...
          content: SingleChildScrollView(
            child: Padding(
              ...
              child: Text("I understand and agree that by providing my personal data or by clicking the applicable icon or button, I am agreeing "
                ...
                "to be complied with in order to exercise or invoke such rights.",
                              ...
                              Padding(
                                ...
                                child: Text("Alturush (OTP)",
                                  style: GoogleFonts.openSans(
                                    color: Colors.black,fontWeight: FontWeight.bold,fontStyle: FontStyle.normal,fontSize: 16.0,
                                  ),
                                ),
                              ),
                            ],
            ...
            bottom: TabBar(
              ...
              tabs: [
                ...
                Tab(
                  child: Text("LOGIN",
                    style: GoogleFonts.openSans(
                      fontStyle: FontStyle.normal, fontWeight: FontWeight.bold, fontSize: 14.0, color: Colors.white,
                    ),
                  ),
                ),
                    ...
                    Padding(
                      ...
                      child: new TextFormField(
                        ...
                        decoration: InputDecoration(
                          hintText: 'Username',
                          prefixIcon: Icon(
                            CupertinoIcons.person, color: Colors.deepOrange[300],
                          ),
                          contentPadding:
...
//                        },
                    ...
                    Padding(
                      ...
                      child: new TextFormField(
                        ...
                        decoration: InputDecoration(
                          hintText: 'Password',
                          prefixIcon: Icon(
                            CupertinoIcons.lock, color: Colors.deepOrange[300],
                          ),
                          suffix: InkWell(
                            ...
                            child: Padding(
                              ...
                              child: Icon(
                                _isHidden ? Icons.visibility : Icons.visibility_off, size: 18,
                              ),
                            ),
                          ),
                          contentPadding:
                    ...
                    Visibility(
                      ...
                      child: Padding(
                        ...
                        child: Center(
                          child: Text('Too many login attempts. Please try again after $minutes:$seconds',
                          ...
                          Flexible(
                            child: new TextFormField(
                              ...
                              decoration: InputDecoration(
                                ...
                                focusedBorder: OutlineInputBorder(
                                  borderSide: BorderSide(
                                    color: Colors.deepOrange.withOpacity(0.8), width: 2.0,
                                  ),
                                ),
                                border: OutlineInputBorder(
                                  borderRadius: BorderRadius.circular(5.0),
                ...
                child: Row(
                  children: <Widget>[
                    Padding(
                      ...
                      child: Text("Account Recovery",
                        style: GoogleFonts.openSans(
                          color: Colors.white, fontWeight: FontWeight.bold, fontStyle: FontStyle.normal, fontSize: 16.0,
                        ),
                      ),
                    ),
                  ],
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Padding(padding: EdgeInsets.fromLTRB(10, 10, 0, 10),
                child: new Text("Enter OTP CODE sent to: $mobileNumber",
                  style: GoogleFonts.openSans(
                    fontStyle: FontStyle.normal, fontSize: 15.0, color: Colors.black54,
                  ),
                ),
              ),
