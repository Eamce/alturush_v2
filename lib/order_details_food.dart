...
class ToDeliverFood extends StatefulWidget {
  ...
  final type;
  final ticketId;
  ToDeliverFood({Key key,
    @required
    this.pend,
    this.ticketNo,
    this.mop,
    this.type,
    this.ticketId}) : super(key: key);//
  @override
                                  ...
                                  child:Container(
                                    child: Row(
                                      ...
                                      children:[
                                        ...
                                        Text('₱ ${loadItems[mainItemIndex]['add_ons'][index]['addon_price']}',
                                ...
                                child:Container(
                                  child: Row(
                                    ...
                                    children:[
                                      ...
                                      Text('₱ ${loadItems[mainItemIndex]['add_ons'][index]['addon_price'].toString()}',
                                        style: TextStyle(fontSize: 14.0),
                                      ),
                                    ],
                                  ),
