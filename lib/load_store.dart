                                      ...
                                      children: <Widget>[
                                        index == 0 ? ListTile(
                                          ...
                                          title: Text("All items",
                                            style: GoogleFonts.openSans(
                                              color: Colors.black54, fontStyle: FontStyle.normal, fontWeight:FontWeight.bold, fontSize: 18.0,
                                            ),
                                          ),
                                        ) :
                                        ListTile(
          ...
          actions: <Widget>[
            ...
            //  animationType: BadgeAnimationType.slide,
              ...
              badgeContent: Text('${cartCount.toString()}',
                style: GoogleFonts.openSans(
                  color: Colors.deepOrange[400], fontSize: 10, fontWeight: FontWeight.bold,
                ),
              ),
              child: Padding(
                                ...
                                children: <Widget>[
                                  ListTile(
                                    ...
                                    title: Text('${widget.tenantName} - ${widget.buAcroname}',
                                      style: GoogleFonts.openSans(
                                        color: Colors.white, fontWeight: FontWeight.bold, fontStyle: FontStyle.normal, fontSize: 20.0,
                                      ),
                                    ),
                                    subtitle: Text('Welcome! Select your best choice',
                                      style: GoogleFonts.openSans(
                                        color: Colors.white, fontStyle: FontStyle.normal, fontSize: 13.0, fontWeight: FontWeight.bold,
                                      ),
                                    ),
                                    dense: true,
                                  ),
                        ...
                        child: Container(
                          ...
                          child: Padding(
                            ...
                            child: new Text(categoryName,
                              style: GoogleFonts.openSans(
                                fontWeight: FontWeight.bold, fontStyle: FontStyle.normal, fontSize: 18.0, color: Colors.white,
                              ),
                            ),
                          ),
                        ),
                              ...
                              Center(
                                child: SizedBox(
                                  ...
                                  child: TextButton.icon(
                                    ...
                                    icon: FaIcon(FontAwesomeIcons.viber),
                                    label: Text("Alturas food delivery",
                              ...
                              return GestureDetector(
                                ...
                                child: Container(
                                  decoration: BoxDecoration(
                                    border: Border(
                                      top: BorderSide(
                                        width: 1.0, color: Colors.deepOrange[100],
                                      ),
                                      right: BorderSide(
                                        width: 1.0, color: Colors.deepOrange[300],
                                      ),
                                      left: BorderSide(
                                        width: 1.0, color: Colors.deepOrange[100],
                                      ),
