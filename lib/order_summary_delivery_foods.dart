                          ...
                          SizedBox(width: 220, height: 35,
                            child: TextFormField(
                              ...
                              decoration: InputDecoration(
                                prefixIcon: Icon(
                                  Icons.date_range,color: Colors.deepOrangeAccent,
                                ),
                    ...
                    child: Column(
                      children: <Widget>[
                        OutlinedButton(
                          ...
                          child: Text("Ticket No. ${widget.ticketNo} has been cancelled.",
                                ...
                                children: <Widget>[
                                  ...
                                  Padding(
                                    ...
                                    child: Text("$discounted",
                                      style: TextStyle(
                                        fontSize: 13, color: Colors.orangeAccent, fontWeight: FontWeight.bold,
                                      ),
                                    ),
                                  ),
                                ],
                          ...
                          children: <Widget>[
                            ...
                            Padding(
                              ...
                              child: Text('$paymentMethod',
                                style: TextStyle(
                                  fontSize: 13, color: Colors.black87, fontWeight: FontWeight.normal,
                                ),
                              ),
                            ),
                          ],
                                      ...
                                      child: IntrinsicHeight(
                                        child: Row(
                                          ...
                                          children: <Widget>[
                                            ...
                                            SizedBox(width: 100,
                                              child: Text('${loadVehicle[index]['vehicle_type']}',
                                                style: TextStyle(
                                                  fontSize: 13, fontWeight: FontWeight.normal, color: Colors.black,
                                                ),
                                              ),
                                            ...
                                            SizedBox(width: 75,
                                              child: Text("${loadVehicle[index]['riders_fee']}",
                                                style: TextStyle(
                                                  fontSize: 13, fontWeight: FontWeight.normal, color: Colors.black,
                                                ),
                                              ),
