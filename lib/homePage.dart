          ...
          badges.Badge(
           ...
           // animationType: BadgeAnimationType.slide,
            ...
            badgeContent: Text('${cartCount.toString()}',
              style: TextStyle(
                color: Colors.deepOrange[300], fontSize: 11, fontWeight: FontWeight.bold,
              ),
            ),
            child: Padding(
                    ...
                    children: <Widget>[
                      ...
                      ListTile(
                          ...
                          title: Padding(
                            ...
                            child: Text('Profile',
                              style: GoogleFonts.openSans(
                                fontWeight: FontWeight.bold, color: Colors.black54, fontSize: 16.0,
                              ),
                            ),
                          ),
                          onTap: () async {
                      ...
                      Visibility(
                        ...
                        child: ListTile(
                          ...
                          title: Text('Log out',
                            style: GoogleFonts.openSans(
                              fontWeight: FontWeight.bold, color: Colors.black87, fontSize: 16.0,
                            ),
                          ),
                          onTap: () async{
                            Navigator.of(context).pop();
                                      ...
                                      child:Column(
                                        ...
                                        children: <Widget>[
                                          Padding(
                                            ...
                                            child: Text('Alturush, offers affordable products for you, without any hidden charges.',
                                              maxLines: 3,
                            ...
                            children: <Widget>[
                              ...
                              Padding(
                                ...
                                child: new Text("Select town",
                                  style: GoogleFonts.openSans(
                                    fontStyle: FontStyle.normal, fontSize: 16.0, color: Colors.black54, fontWeight: FontWeight.bold,
                                  ),
                                ),
                              ),
