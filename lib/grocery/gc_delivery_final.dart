                          ...
                          child: Row(
                            ...
                            children: <Widget>[
                              ...
                              Text('₱ ${oCcy.format(conFee)}',
                                style: TextStyle(
                                  fontStyle: FontStyle.normal,fontSize: 14.0, fontWeight: FontWeight.normal,
                                ),
                              ),
                            ],
                          ),
                            ...
                            child: Row(
                              ...
                              children: <Widget>[
                                Text('TOTAL AMOUNT TO PAY',
                                  style: GoogleFonts.openSans(
                                    fontSize: 14.0, fontWeight: FontWeight.bold, color: Colors.green[400],
                                  ),
                                ),
                                Text('₱ ${oCcy.format(grandTotal)}',
                                  style: TextStyle(
                                    fontStyle: FontStyle.normal,fontSize: 14.0, fontWeight: FontWeight.bold,
                                  ),
                                ),
                              ],
                            ),
    ...
    return AlertDialog(
                                    ...
                                    title: Transform.translate(
                                      ...
                                      child: Padding(
                                        ...
                                        child: Column(
                                          crossAxisAlignment: CrossAxisAlignment.start,
                                          children: <Widget>[
                                            Text('${loadIdList[index]['name']} (${loadIdList[index]['discount_name']})',
                                              style: TextStyle(
                                                fontSize: 13, fontStyle: FontStyle.normal, fontWeight: FontWeight.normal, color: Colors.black,
                                              ),
                                            ),
                                            Text('${loadIdList[index]['discount_no']}',
                                              style: TextStyle(
                                                fontSize: 13, fontStyle: FontStyle.normal, fontWeight: FontWeight.normal, color: Colors.black,
                                              ),
                                            ),
      ...
      actions: <Widget>[
        OutlinedButton(
          ...
          child: Text("CLOSE",
            style: GoogleFonts.openSans(
              color:Colors.black54,fontWeight: FontWeight.bold,fontSize: 12.0,
            ),
          ),
        ),
        OutlinedButton(
                ...
                child: Row(
                  children: <Widget>[
                    ...
                    Padding(
                      padding: EdgeInsets.fromLTRB(0, 0, 0, 0),
                      child: Text("Apply Discount ",
                        style: TextStyle(color: Colors.black54, fontWeight: FontWeight.bold, fontStyle: FontStyle.normal, fontSize: 16.0,
                        ),
                      ),
                    ),
                  ],
                    ...
                    children: <Widget>[
                      Padding(
                        ...
                        child: Text('Discount Type',
                          style: GoogleFonts.openSans(
                            fontStyle: FontStyle.normal, fontSize: 15.0, fontWeight: FontWeight.bold, color: Colors.black,
                          ),
                        ),
                      ),
                      SizedBox(height: 40,
                          ...
                          child: DropdownButtonFormField(
                            decoration: InputDecoration(
                              ...
                              focusedBorder: OutlineInputBorder(
                                ...
                                borderSide: BorderSide(
                                  color: Colors.green.withOpacity(0.8), width: 1,
                                ),
                              ),
                            ...
                            hint: const Text('Select Discount Type',
                              style: TextStyle(
                                fontStyle: FontStyle.normal, fontSize: 14, fontWeight: FontWeight.normal, color: Colors.black,
                              ),
                            ),
                            icon: const Icon(
                            ...
                            iconSize: 25,
                            items: _loadDiscount.map((item) =>
                              DropdownMenuItem<String>(
                                value: item,
                                child: Text(item,
                                  style: GoogleFonts.openSans(
                                    fontStyle: FontStyle.normal, fontSize: 14.0, fontWeight: FontWeight.normal, color: Colors.black,
                                  ),
                                ),
                              )).toList(),
