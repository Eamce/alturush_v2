                                           ...
                                           ListTile(
                                            ...
                                            title: Text(categoryData[index]['category_name'].toString(),
                                              style: GoogleFonts.openSans(
                                                color: Colors.black54,
                                                  fontStyle: FontStyle.normal,fontWeight:FontWeight.bold,fontSize: 22.0,
                                              ),
                                            ),
                                          ),
                                        ],
      ...
      appBar: AppBar(
        ...
        actions: [
          status == null ? TextButton(
            ...
            child: Text("Login",
              style: GoogleFonts.openSans(
                color:Colors.deepOrange,fontWeight: FontWeight.bold,fontSize: 18.0,
              ),
            ),
          ) :
          IconButton(
              ...
              child: Scrollbar(
                child:ListView(
                  ...
                  children: <Widget>[
                    ...
                    Center(
                      child:Text("Howdy ${firstName.toString()}",
                        style: GoogleFonts.openSans(
                          fontStyle: FontStyle.normal,fontWeight:FontWeight.bold,fontSize: 23.0,
                        ),
                      ),
                    ),
                    Center(
                                ...
                                children: <Widget>[
                                  ListTile(
                                    ...
                                    title: Text(buData[index]['business_unit'],
                                      style: GoogleFonts.openSans(
                                        color: Colors.black54,fontStyle: FontStyle.normal,fontWeight:FontWeight.bold,fontSize: 22.0,
                                      ),
                                    ),
                                  ),
                                ],
