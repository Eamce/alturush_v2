                                                              ...
                                                              child: Padding(
                                                                ...
                                                                child: Container(height: 25, width: 60,
                                                                  child: OutlinedButton(
                                                                    ...
                                                                    child:Text("Pending",
                                                                      style: TextStyle(
                                                                        color: Colors.white, fontSize: 13, fontStyle: FontStyle.normal,
                                                                      ),
                                                                    ),
                                                                  ),
                                                                ),
                                                              ...
                                                              child: Column(
                                                                ...
                                                                children: <Widget>[
                                                                  Text("₱ ${loadItems[index1]['total_price']}",
                                                                    style: TextStyle(
                                                                      fontWeight: FontWeight.normal, fontSize: 13, color: Colors.green,
                                                                    ),
                                                                  ),
                                                                ],
                                                              ),
                                      ...
                                      child: SizedBox(
                                        ...
                                        child: OutlinedButton(
                                          ...
                                          child:Text("CANCEL ORDER(S)",
                                            style: TextStyle(
                                              color: Colors.white, fontSize: 13, fontStyle: FontStyle.normal, fontWeight: FontWeight.bold,
                                            ),
                                          ),
                                        ),
                                      ),
