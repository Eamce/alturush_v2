      ...
      actions: <Widget>[
        ...
        badges.Badge(
          ...
          badgeContent: Text('${cartCount.toString()}',
            style: TextStyle(
              color: Colors.green[400], fontSize: 11, fontWeight: FontWeight.bold,
            ),
          ),
          child: Padding(
                                        ...
                                        ListTile(
                                          ...
                                          title: Text(categoryData[index]['category_name'].toString(),
                                            style: GoogleFonts.openSans(
                                              color: Colors.black,fontStyle: FontStyle.normal,fontWeight:FontWeight.bold,fontSize: 18.0,
                                            ),
                                          ),
                                        ),
                                      ],
                            ...
                            return GestureDetector(
                              ...
                              child: Container(
                                decoration: BoxDecoration(
                                  border: Border(
                                    top: BorderSide(
                                      width: 1.0, color: Colors.green[100],
                                    ),
                                    right: BorderSide(
                                      width: 1.0, color: Colors.green[300],
                                    ),
                                    left: BorderSide(
                                      width: 1.0, color: Colors.green[100],
                                    ),
