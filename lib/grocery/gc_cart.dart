                                          ...
                                          children: <Widget> [
                                            ...
                                            Padding(
                                              ...
                                              child: Text('Does not reached minimum order',
                                                style: GoogleFonts.openSans(
                                                  fontSize: 14.0, fontWeight: FontWeight.bold, color: Colors.redAccent,
                                                ),
                                              ),
                                            ),
                                          ],
                                  ...
                                  child: Row(
                                    children:  <Widget> [
                                      Padding(
                                        ...
                                        child: Text('${getTotalAmount[index]['buName']}',
                                          style: GoogleFonts.openSans(
                                                          ...
                                                          children: <Widget>[
                                                            ...
                                                            Padding(
                                                              ...
                                                              child: Text("₱ ${loadCartData[index0]['total_price']}",
                                                                style: TextStyle(
                                                                  fontWeight: FontWeight.normal, fontSize: 13, color: Colors.black87,
                                                                ),
                                                              ),
                                                            ),
                                                          ],
                                                                    ...
                                                                    child: TextButton(
                                                                      ...
                                                                      onPressed: side1[index0] ? null :() async{
                                                                        setState(() {
                                                                          ...
                                                                          updateCartQty(
                                                                            loadCartData[index0]['cart_id'].toString(),
                                                                            loadCartData[index0]['cart_qty'].toString(),
                                                                          );
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            Text('No. of Store(s)',
                              style: TextStyle(
                                fontStyle: FontStyle.normal,fontSize: 13.0, fontWeight: FontWeight.bold, color: Colors.black54,
                              ),
                            ),
                            Text('$stores',
                              style: TextStyle(
                                fontStyle: FontStyle.normal,fontSize: 13.0, fontWeight: FontWeight.normal, color: Colors.black.withOpacity(0.7),
                              ),
                            ),
                          ],
                        ),
                          ...
                          child: Row(
                            ...
                            children: <Widget>[
                              Text('TOTAL AMOUNT TO PAY',
                                style: TextStyle(fontStyle: FontStyle.normal,fontSize: 13.0, fontWeight: FontWeight.bold, color: Colors.green,
                                ),
                              ),
                              Text('₱ ${oCcy.format(grandTotal)}',
                                style: TextStyle(fontStyle: FontStyle.normal,fontSize: 13.0, fontWeight: FontWeight.bold, color: Colors.black.withOpacity(0.7),
                                ),
                              ),
                            ],
                          ),
                        ...
                        child: DropdownButtonFormField(
                          ...
                          items: _options.map((item) =>
                              DropdownMenuItem<String>(
                                ...
                                child: Text(item,
                                  style: TextStyle(
                                    fontStyle: FontStyle.normal, fontSize: 13.0, fontWeight: FontWeight.normal, color: Colors.black54,
                                  ),
                                ),
                              )).toList(),
                        ...
                        child: SleekButton(
                          ...
                          child: Center(
                            ...
                            : Text("PROCESS CHECKOUT",
                              style: GoogleFonts.openSans(
                                fontStyle: FontStyle.normal, fontWeight: FontWeight.bold, fontSize: 16.0,
                                shadows: [
                                  Shadow(
                                    blurRadius: 1.0,
                                    color: Colors.black54,
