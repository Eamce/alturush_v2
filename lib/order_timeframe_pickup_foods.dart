...
class OrderTimeFramePickupFoods extends StatefulWidget {
  ...
  const OrderTimeFramePickupFoods({Key key,
    this.ticketNo,
    this.mop,
    this.acroname,
    this.tenantName,
    this.tenantId,
    this.ifCancelled}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Order Time Frame (Pick-up)",
                            ...
                            children: <Widget>[
                              ...
                              Padding(
                                ...
                                child: Text('(Submitted Order by Tenant)',
                                  style: TextStyle(
                                    fontWeight: FontWeight.normal, fontSize: 13, color: Colors.deepOrangeAccent,
                                  ),
                                ),
                              ),
