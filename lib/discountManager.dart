                ...
                SizedBox(height: 30,
                  child: Padding(
                    ...
                    child:OutlinedButton(
                      ...
                      child: Text('+ ADD',
                        style: GoogleFonts.openSans(
                          fontWeight: FontWeight.bold, fontSize: 13.0, color: Colors.deepOrangeAccent,
                        ),
                      ),
                      style: ButtonStyle(
                  ...
                  children: <Widget>[
                    exist == false ? Padding(
                      ...
                      child: Text('No Discount Details',
                        style: GoogleFonts.openSans(
                          fontStyle: FontStyle.normal, fontSize: 14, color: Colors.black54,
                        ),
                      ),
                    ) :
                    ListView.builder(
                    ...
                    children: <Widget>[
                            ...
                            decoration: InputDecoration(
                              ...
                              focusedBorder: OutlineInputBorder(
                                ...
                                borderSide: BorderSide(
                                  color: Colors.deepOrangeAccent.withOpacity(0.8), width: 1,
                                ),
                              ),
                      ...
                      Padding(
                        ...
                        child: Text('Full Name',
                          style: TextStyle(
                            fontStyle: FontStyle.normal, fontSize: 16.0, fontWeight: FontWeight.bold, color: Colors.black,
                          ),
                        ),
                      ),
      ...
      actions: <Widget>[
        OutlinedButton(
          style: TextButton.styleFrom(
            foregroundColor: Colors.black, shape: new RoundedRectangleBorder(
        ...
        OutlinedButton(
          ...
          child:Text("APPLY",
            style: GoogleFonts.openSans(color:Colors.white,fontWeight: FontWeight.bold,fontSize: 12.0,
            ),
          ),
        ),
      ],
