                  ...
                  child: Container(
                    decoration: BoxDecoration(
                      gradient: LinearGradient(
                        ...
                        colors: <Color>[
                          Colors.deepOrange, Colors.deepOrange[200],
                        ],
                      ),
                      ...
                      image: DecorationImage(
                        ...
                        colorFilter: ColorFilter.mode(
                          Colors.black54.withOpacity(0.8), BlendMode.dstATop,
                        ),
                      ),
                    ),
                    child: Card(
                          ...
                          Padding(
                            ...
                            child: new Column(
                              ...
                              children: <Widget>[
                                ...
                                Text('Joined $date',
                                  style: GoogleFonts.openSans(
                                    fontWeight: FontWeight.normal, fontStyle: FontStyle.normal, fontSize: 16.0, color: Colors.white,
                                  ),
                                ),
                              ],
                            ),
