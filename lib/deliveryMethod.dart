                                    ...
                                    children: <Widget>[
                                      Expanded(
                                        child: Text('+ ${loadIMainItems[mainItemIndex]['suggestions'][f]['description']}',
                                          ...
                                          style: GoogleFonts.openSans(
                                            fontSize: 14.0, color: Colors.black54, fontWeight: FontWeight.bold,
                                          ),
                                        ),
                                      ),
                                      Text('${flavorPrice}',
                      ...
                      child: Padding(
                        ...
                        child:Row(
                          ...
                          children: <Widget>[
                            ...
                            Text('₱${getItemsData[index]['prod_price']}',
                              style: TextStyle(fontSize: 13.0,fontWeight: FontWeight.bold),
                            ),
                            Text(' x ${getItemsData[index]['d_quantity']}',
                              style: TextStyle(fontSize: 13.0,fontWeight: FontWeight.bold),
                            ),
                          ],
                        ),
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          leading: IconButton(
            icon: Icon(
              CupertinoIcons.left_chevron, color: Colors.white, size: 20,
            ),
                                ...
                                child: InkWell(
                                  ...
                                  child: IgnorePointer(
                                    child: new TextFormField(
                                      ...
                                      decoration: InputDecoration(
                                        prefixIcon: Icon(
                                          Icons.date_range,color: Colors.deepOrange[400],
                                        ),
                                        contentPadding: EdgeInsets.all(0),
                                        focusedBorder:OutlineInputBorder(
                                ...
                                child: InkWell(
                                  ...
                                  child: IgnorePointer(
                                    child: new TextFormField(
                                      ...
                                      decoration: InputDecoration(
                                        prefixIcon: Icon(
                                          CupertinoIcons.time, color: Colors.deepOrangeAccent,
                                        ),
                                        contentPadding: EdgeInsets.all(0),
                                        focusedBorder:OutlineInputBorder(
                                          borderSide: BorderSide(
